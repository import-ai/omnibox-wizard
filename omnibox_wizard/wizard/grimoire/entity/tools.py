...
class PrivateSearchTool(BaseTool):
    ...
    visible_resources: list[Resource] = Field(
        default=None, exclude=True, description="Required in `AgentRequest`, excluded in `MessageDto`.")
    ...
    def to_condition(self) -> Condition:
        ...
        trace.get_current_span().set_attribute("len(visible_resources)", len(self.visible_resources))
        return Condition(
