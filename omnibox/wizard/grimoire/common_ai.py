...
from omnibox.common.json_parser import parse_json
from omnibox.common.template_render import render_template
from omnibox.common.trace_info import TraceInfo
from omnibox.wizard.config import GrimoireOpenAIConfig
...
class CommonAI:
    ...
    def __init__(self, config: GrimoireOpenAIConfig):
        ...
        with project_root.open("omnibox/resources/prompts/title.md") as f:
            self.title_system_prompt_template: str = f.read()
        with project_root.open("omnibox/resources/prompts/tag.md") as f:
