...
from src.wizard.api.internal import internal_router, init as internal_init
from src.wizard.api.v1 import v1_router
from src.wizard.api.wizard import init as grimoire_init
