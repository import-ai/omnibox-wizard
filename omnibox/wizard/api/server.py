...
from omnibox.wizard.api.internal import internal_router, init as internal_init
from omnibox.wizard.api.v1 import v1_router
from omnibox.wizard.api.wizard import init as grimoire_init
