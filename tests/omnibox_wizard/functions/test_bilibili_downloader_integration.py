...
class TestBilibiliDownloaderIntegration:
    ...
    def test_extract_video_id_real_url(self):
        ...
        video_id = downloader._extract_video_id(self.BILIBILI_URL)
        ...
        for url in other_formats:
            assert downloader._extract_video_id(url) == "BV1uT4y1P7CX"
    
    def test_get_video_info_real_url(self):
        downloader = BilibiliDownloader()
        
        video_info = downloader.get_video_info(self.BILIBILI_URL)
    ...
    def test_video_id_extraction_edge_cases(self):
        ...
        for url, expected_id in test_cases:
            actual_id = downloader._extract_video_id(url)
    ...
    def test_fallback_video_id(self):
        ...
        video_id = downloader._extract_video_id(bangumi_url)
