...
from omnibox.common.template_parser import TemplateParser
from omnibox.common.trace_info import TraceInfo
from omnibox.common.utils import remove_continuous_break_lines
from omnibox.wizard.config import OpenAIConfig, Config
from omnibox.wizard.grimoire.agent.stream_parser import StreamParser, DeltaOperation
from omnibox.wizard.grimoire.agent.tool_executor import ToolExecutor
from omnibox.wizard.grimoire.base_streamable import BaseStreamable, ChatResponse
from omnibox.wizard.grimoire.entity.api import (
...
from omnibox.wizard.grimoire.entity.chunk import ResourceChunkRetrieval
from omnibox.wizard.grimoire.entity.tools import ToolExecutorConfig, ToolDict, Resource, ALL_TOOLS
from omnibox.wizard.grimoire.retriever.base import BaseRetriever
from omnibox.wizard.grimoire.retriever.meili_vector_db import MeiliVectorRetriever
from omnibox.wizard.grimoire.retriever.reranker import get_tool_executor_config, get_merged_description, Reranker
from omnibox.wizard.grimoire.retriever.searxng import SearXNG
...
class Agent(BaseSearchableAgent):
    def __init__(self, config: Config, system_prompt_template_name: str):
        ...
        self.template_parser = TemplateParser(base_dir=project_root.path("omnibox/resources/prompt_templates"))
