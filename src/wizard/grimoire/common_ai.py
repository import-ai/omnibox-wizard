...
class CommonAI:
    ...
    def __init__(self, config: GrimoireOpenAIConfig):
        ...
        with project_root.open("src/resources/prompts/title.md") as f:
            self.title_system_prompt_template: str = f.read()
        with project_root.open("src/resources/prompts/tag.md") as f:
